	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="signin.jsp"><span class="glyphicon glyphicon-log-in"></span>Signin</a></li>
			</ul>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images\clothban.jpg" alt="apparel" />
			</div>

			<div class="item">
				<img src="images\banacc.jpg" alt="ac" />
			</div>

			<div class="item">
				<img src="images\cosmeticb.jpg" alt="cos" />
			</div>
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<img src="images\chud.jpg" class="img-rounded" alt="Image"
			...
			<div class="col-sm-6">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<img src="images\pinkyac.jpg" class="img-rounded" alt="Image"
							width="525" height="300">
					</div>
					<div class="panel-footer">
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<img src="images\cosmet.jpg" class="img-rounded" alt="Image"
							width="525" height="300">
					</div>
					<div class="panel-footer">
			...
			<div class="col-sm-6">
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<img src="images\offerethnic.jpg" class="img-rounded" alt="Image"
							width="525" height="300">
					</div>
					<div class="panel-footer">
